...
@implementation MainScene {
    ...
    CCNode *_cloud1, *_cloud2;
    NSArray *_clouds;
    
    CCNode *_bush1, *_bush2;
    NSArray *_bushes;
...
- (void)didLoadFromCCB {
    ...
    // Spritebuilder does not have a CCParallaxNode at the moment, so do this in code
...
- (void)update:(CCTime)delta
{
    ...
    // Will be replaced by code handling parallax
    /*
    for (CCNode *bush in _bushes) {
        // move the bush
